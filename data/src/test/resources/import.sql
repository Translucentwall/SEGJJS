...
insert into affiliations (id,country, af_name, formatted_name) values (1,'china','nju','nju'),(2,'usa','google','google');
...
insert into author_affiliation_year (id,author_id,affiliation_id,`year`) values (1,1,1,2012),(2,1,2,2020);